...
curl -sS -X POST \
  ...
  "https://us-central1-aiplatform.googleapis.com/v1/projects/divine-climate-476722-a2/locations/us-central1/publishers/google/models/gemini-2.5-flash:generateContent" \
  -d '{
    "contents": [
